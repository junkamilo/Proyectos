      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><a href="/texto" className="hover:text-[#e100ff] transition-colors flex items-center gap-2"><span className="w-1 h-1 bg-[#e100ff] rounded-full"></span>Textos</a></li>
              ...
              <li><a href="/nombresCasosPrubas" className="hover:text-teal-400 transition-colors flex items-center gap-2"><span className="w-1 h-1 bg-fuchsia-600 rounded-full"></span>Objetivos</a></li>

              <li><a href="/titulos" className="hover:text-gray-400 transition-colors flex items-center gap-2"><span className="w-1 h-1 bg-gray-500 rounded-full"></span>Titulos</a></li>
              <li><a href="/ejemploPrueba" className="hover:text-orange-400 transition-colors flex items-center gap-2"><span className="w-1 h-1 bg-orange-400 rounded-full"></span>Ejemplo pruebas</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><a href="https://legal.rappi.com.co/colombia/terminos-y-condiciones-de-uso-de-plataforma-rappi-2/"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-white transition-colors">Términos y Condiciones</a></li>
              <li><a href="https://legal.rappi.com.co/colombia/politica-de-proteccion-y-tratamiento-de-datos-personales-rappi-s-a-s/"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-white transition-colors">Política de Privacidad</a></li>
              <li><a href="https://soyrappi.com.co/soporte"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-white transition-colors">Soporte Técnico</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <a href="https://apps.apple.com/co/app/rappi-pide-todo-en-minutos/id984044296"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center bg-white/10 hover:bg-white/20 transition-colors border border-white/10 rounded-xl px-4 py-2 text-left w-full max-w-[180px]">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex space-x-4">
            <a href="https://www.facebook.com/RappiColombia/?locale=es_LA"
            target="_blank"
            className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#ff4d38] hover:text-white transition-all duration-300">
