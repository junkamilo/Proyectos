const search = () => {
  ...
  input.className ="w-full sm:w-64 border border-slate-300 rounded-full py-2 pl-4 pr-10 text-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all duration-300";
